...
@WebServlet(name = "seeAppointmentServlet")
public class seeAppointmentServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String dayAddedDate = dayAddedDate(sqlDateNOW,nextDay);
        ...
        try {
            ...
            String sql = "select * from appointments,doctor,user where appointments.doctor_id = doctor.id" +
                    " and user.id = doctor.id and appointments.appointment_date between '"+sqlDateNOW+"' and '"+dayAddedDate+"'";
        ...
        request.getRequestDispatcher("seeAppointment.jsp").forward(request, response);
    ...
    public static String dayAddedDate(String date,int gun){
